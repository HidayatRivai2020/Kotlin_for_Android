...
fun main(args: Array<String>) {
    ...
    println("-----------------------------------------------")
    // Show the values of array from Integer
    println(age[0])
    println(age.get(1))

    // Show array values with loop
    for (a in age) {
        println(a)
    }

    // Show array values with indices
    for (a in age.indices) {
        println("index $a is ${age[a]}")
    }

    println("-----------------------------------------------")
    // Show the values of array from String
    ...
    // Show array values rangeTo Array Size - 1
    ...
    println("-----------------------------------------------")
    // Show the values of array from Integer and String Combination
    ...
    // Show array values until array size
